---
layout: page
title: ML Mapping of Soil Salinity for Land Degradation
...
{% include figure.liquid loading="eager" path="assets/img/salinity_map.png" title="Graphical abstract" class="img-fluid rounded z-depth-1" %}
:::
::::
